...
static int i2c_bus_thread(void *arg) {
    ...
    while (1) {
        ...
        i2c_txn_t* txn = list_remove_head_type(&i2c_bus->queued_txns, i2c_txn_t, node);
...
zx_status_t platform_i2c_transact(platform_bus_t* bus, pdev_req_t* req, pbus_i2c_channel_t* channel,
    ...
    size_t write_length = req->i2c_txn.write_length;
    size_t read_length = req->i2c_txn.read_length;
